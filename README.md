# biggr
A python library for [BiGGr Models](https://biggr.org) that facilitates using its API.
It aims to make all of the information in the database available where it is most
useful: directly in your python script, application, or cobrapy project.
